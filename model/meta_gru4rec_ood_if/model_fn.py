...
@model("meta_gru4rec_ood_if", MetaType.ModelBuilder)
class GRU4Rec(nn.Module):
    ...
    def forward(self, features, pred=False, train_ood_threshold=0.99):
        ...
        if not pred:
            ...
            user_embedding, trigger_embed_ = self._meta_classifier_param_list(trigger_user_state, trigger_embed,
                                                                              trigger_user_state.size()[0],
                                                                              trigger_seq_length)
